...
create empty ones with the right prototype also by not forgeting to push your main.h file to your repository. It should at least contain all the prototypes of the above functions.
